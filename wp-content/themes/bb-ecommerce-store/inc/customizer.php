...
function bb_ecommerce_store_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('bb_ecommerce_store_product_sale_section', array(
		'title'    => __('Product Sale Button Settings', 'bb-ecommerce-store'),
		'priority' => null,
		'panel'    => 'woocommerce',
	));
	...
	$wp_customize->add_control('bb_ecommerce_store_align_product_sale',array(
        ...
        'section' => 'bb_ecommerce_store_product_sale_section',
        'choices' => array(
