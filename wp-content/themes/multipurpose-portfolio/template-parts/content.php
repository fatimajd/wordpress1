...
<article class="blog-sec text-center animated fadeInDown p-2 mb-4">
  ...
  <?php if( get_theme_mod( 'multipurpose_portfolio_metafields_date',true) != '' || get_theme_mod( 'multipurpose_portfolio_metafields_author',true) != '' || get_theme_mod( 'multipurpose_portfolio_metafields_comment',true) != '') { ?>
    <div class="post-info p-2 mb-2">
      <?php if( get_theme_mod( 'multipurpose_portfolio_metafields_date',true) != '') { ?>
      ...
      <?php }?>
      <?php if( get_theme_mod( 'multipurpose_portfolio_metafields_author',true) != '') { ?>
      ...
      <?php }?>
      <?php if( get_theme_mod( 'multipurpose_portfolio_metafields_comment',true) != '') { ?>
  ...
  <?php }?>
  <?php if(get_theme_mod('multipurpose_portfolio_blog_post_content') == 'Full Content'){ ?>
    <?php the_content(); ?>
  <?php }
  if(get_theme_mod('multipurpose_portfolio_blog_post_content', 'Excerpt Content') == 'Excerpt Content'){ ?>
