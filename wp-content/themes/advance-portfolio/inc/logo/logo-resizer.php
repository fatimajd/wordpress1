...
function advance_portfolio_logo_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('advance_portfolio_site_title_size_option',array(
		'default'	=> 25,
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float'
	));
	$wp_customize->add_control('advance_portfolio_site_title_size_option',array(
		'label'	=> __('Site Title Size option','advance-portfolio'),
		'section'	=> 'title_tagline',
		'setting'	=> 'advance_portfolio_site_title_size_option',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
    ...
    $wp_customize->add_setting('advance_portfolio_site_tagline_size_option',array(
		'default'	=> 13,
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float'
	));
	$wp_customize->add_control('advance_portfolio_site_tagline_size_option',array(
		'label'	=> __('Site Tagline Size option','advance-portfolio'),
		'section'	=> 'title_tagline',
		'setting'	=> 'advance_portfolio_site_tagline_size_option',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
