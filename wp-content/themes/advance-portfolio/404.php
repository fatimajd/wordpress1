        ...
        <div class="middle-align">
			...
			<?php if( get_theme_mod('advance_portfolio_button_404_page','Back to Home Page') != ''){ ?>
				<div class="read-moresec py-4 px-0">
	        		<a href="<?php echo esc_url(home_url()); ?>" class="button mt-3 mx-0 mb-0 py-2 px-3"><?php echo esc_html(get_theme_mod('advance_portfolio_button_404_page',__('Back to Home Page','advance-portfolio')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('advance_portfolio_button_404_page',__('Back to Home Page','advance-portfolio')));?></span></a>
	        	</div>
        	<?php } ?>
